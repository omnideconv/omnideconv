...
#'   are samples. Can also just be the filename of the bulk expression data in the correct format
#'   (generated by using this method). The file needs to be in the folder "input_dir".
