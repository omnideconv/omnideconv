...
#'
#' A dataset of eight RNA-seq samples from patients vaccinated with trivalent inactivated influenza vaccine (TIV)
#'
...
#'
#' A dataset of eight RNA-seq samples from patients vaccinated with trivalent inactivated influenza vaccine (TIV) including only 100 genes
#'
#' @format matrix with genes x samples
#'
#' @source Hoek et al. (2015), PLOS ONE, https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0118528
...
#'
#' A small subset of TPM-normalized single-cell RNA-seq gene expression, containing 50 cells with types "T cell CD4", "T cell CD8", "B cell", "Monocyte conventional", "NK cell" and only 100 genes
#'
#' @format matrix with genes x cells
#'
#' @source Maynard et al. (2020), Cell, https://www.sciencedirect.com/science/article/pii/S0092867420308825
