...
#'
#' @examples
deconvolute <- function(bulk_gene_expression, signature, method = deconvolution_methods, single_cell_object = NULL, cell_type_annotations = NULL, cell_type_column_name=NULL, verbose = FALSE, ...){
  ...
  deconv <- switch(tolower(method),
                   ...
                   autogenes = deconvolute_autogenes(bulk_gene_expression, signature,verbose = verbose, ...)$proportions
  )
