...
devtools::install_github("omnideconv/omnideconv", dependencies = c("Imports", "Suggests"))
...
load("data/cell_type_annotations_1.RData")
load("data/single_cell_data_1.RData")
```

### 1. Build a Signature Matrix

```{r signature, eval=FALSE}
omnideconv::build_model(single_cell_data_1, cell_type_annotations_1, method = "dwls")
```
...
signature_matrix <- omnideconv::build_model(single_cell_data_1, cell_type_annotations_1, "dwls")
```
