...
```{r plotScores}
melted_li <- melt(li[[1]])
ggplot(melted_li, aes(x=method, y=value, fill=variable))+geom_violin(position=position_dodge(1))+facet_wrap(~sample)+labs(title="deviation from the ground truth")
