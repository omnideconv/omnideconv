...
knitr::kable(data.frame(Deconv_method=c("Bisque", "CibersortX", "DWLS", "MOMF", "Scaden"), Bisque=c("yes", "-", "-", "yes", "-"), CibersortX=c("yes", "yes", "yes", "yes", "-"), DWLS=c("yes", "yes", "yes", "yes", "-"), MOMF=c("yes", "-", "-", "yes", "-"), Scaden=c("-", "-", "-", "-", "yes")), caption = "Interchangeability table: 'Yes' indicates, that a signature matrix built by the method in the according column can be used for deconvolution with the method from the according row.")
```
