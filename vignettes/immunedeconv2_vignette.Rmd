...
res_bisque$T_cell <- rowSums(res_bisque[,c("T cell CD4", "T cell CD8", "T cell regulatory", "T cell dividing")])
...
res_momf$T_cell <- rowSums(res_momf[,c("T cell CD4", "T cell CD8", "T cell regulatory", "T cell dividing")])
...
res_scaden$T_cell <- rowSums(res_scaden[,c("T.cell.CD4", "T.cell.CD8", "T.cell.regulatory", "T.cell.dividing")])
...
res_dwls$T_cell <- rowSums(res_dwls[,c("T_cell_CD4", "T_cell_CD8", "T_cell_regulatory", "T_cell_dividing")])
...
df <- rbind(res_bisque_melt, res_momf_melt) %>% rbind(res_dwls_melt) %>% rbind(res_scaden_melt)
df$cell_type <- gsub(" ", "_", df$cell_type)
df$cell_type <- gsub(".", "_", df$cell_type, fixed=TRUE)
