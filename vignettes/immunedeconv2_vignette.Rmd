...
We also provide some sample data, a bigger and a smaller set of single cell RNA-seq matrix (subset of Maynard et al. 2020), cell type annotations and bulk RNA-seq matrix (Hoek et al. 2015). 
...
# 4. Benchmarking
To evaluate the performance of the methods used, we compared the whole data set with 17k cells from Hoek et al to its ground truth that was measured with FACS. This testset is also included in a benchmarking method, which takes the desired filename and -type as a parameter.
