...
deconvolution.results.dwls <- readRDS("vignette_files/deconvolution.results.dwls.rds")
deconvolution.results.bayesprism <- readRDS("vignette_files/deconvolution.results.bayesprism.rds")
deconvolution.results.dwls.minor <- readRDS("vignette_files/deconvolution.results.dwls.minor.rds")
...
patients.results %>%
  ...
  labs(x = "IHC Subtype", y = "Cell Fraction",
...
patients.results %>%
  ...
  labs(x = "Treatment", y = "Cell Fraction",
