...
knitr::include_graphics("logo/omnideconv_logo.jpg")
```
...
signature.matrix.dwls <- readRDS('./vignette_files/signature.dwls.rds')
signature.matrix.dwls.minor <- readRDS('./vignette_files/signature.dwls.minor.rds')
deconvolution.results.dwls <- readRDS('./vignette_files/deconvolution.dwls.rds')
deconvolution.results.dwls.minor <- readRDS('./vignette_files/deconovlution.results.dwls.minor.rds')
...
```{r echo=FALSE}
knitr::kable(as.data.frame(table(single.cell.data$celltype_major, dnn = list("celltype_major")), responseName = "number_cells"),
...
```{r echo=FALSE}
knitr::kable(as.data.frame(table(single.cell.data$celltype_major, dnn = list("celltype_major")), responseName = "number_cells"),
  caption = "Number of cells per cell type after quality filtering",
  digits = 3
)
```
...
```{r echo=FALSE}
knitr::kable(as.data.frame(table(single.cell.data.sampled$celltype_major, dnn = list("celltype_major")), responseName = "number_cells"),
  caption = "Number of cells per cell type after subsampling",
  digits = 3
)
```
...
```{r, echo=FALSE}
knitr::kable(deconvolution.results.dwls,
  caption = "Cell type fractions obtained by DWLS",
  digits = 3
)
```
...
```{r, echo=FALSE}
knitr::kable(as.data.frame(table(single.cell.data.sampled$celltype_minor, dnn = list("celltype_minor")), responseName = "number_cells"),
  caption = "Number of cells per cell type (minor resolution)  after subsampling",
  digits = 3
)
```
...
```{r, include=FALSE}
knitr::kable(as.data.frame(table(patient.metadata$IHC_subtype, dnn = list("IHC_subtype")), responseName = "number_patients"),
  caption = "Number ofpatients per IHC condition",
  digits = 3
)
```
