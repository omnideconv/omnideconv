...
omnideconv::build_model(single_cell_data, cell_type_annotations, batch_ids, method)
```
...
```{r signatureExample}
signatureMatrix <- omnideconv::build_model(single_cell_data, cell_type_annotations, batch_ids, "bisque")
